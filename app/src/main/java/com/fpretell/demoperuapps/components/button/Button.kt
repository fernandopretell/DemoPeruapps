package com.fpretell.demoperuapps.components.button
...
class Button: LinearLayout {
    ...
    val typefaceRegular = ResourcesCompat.getFont(context,
        R.font.lato_regular
    )
    val typefaceBold = ResourcesCompat.getFont(context,
        R.font.lato_bold
    )
    ...
    var iconLeft: Int = -1
    var iconRight: Int = -1
    var color: Int = ContextCompat.getColor(context,
        R.color.black
    )
    var rippleColor: Int = ContextCompat.getColor(context,
        R.color.gray_1
    )
    var textColor: Int = ContextCompat.getColor(context,
        R.color.white
    )
    ...
    private var colorDisable: Int = ContextCompat.getColor(context,
        R.color.gray_3
    )
    var textWithUnderline: Boolean = false
    private var textColorDisable: Int = ContextCompat.getColor(context,
        R.color.gray_4
    )
    ...
    fun resetStyleColorDisable() {
        this.colorDisable = ContextCompat.getColor(context,
            R.color.gray_3
        )
        this.textColorDisable = ContextCompat.getColor(context,
            R.color.gray_4
        )
        setupUI()
    }
