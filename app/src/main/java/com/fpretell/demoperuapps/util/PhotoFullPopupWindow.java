package com.fpretell.demoperuapps.util;
    ...
    public PhotoFullPopupWindow(Context ctx, int layout, View v, String imageUrl, Bitmap bitmap) {
        ...
        if (bitmap != null) {
            ...
            if (Build.VERSION.SDK_INT >= 16) {
                parent.setBackgroundColor(mContext.getResources().getColor(android.R.color.black));// ));
            } else {
            ...
            Glide.with(ctx).asBitmap()
                    ...
                    .apply(RequestOptions.errorOf(R.drawable.placeholder_user)
